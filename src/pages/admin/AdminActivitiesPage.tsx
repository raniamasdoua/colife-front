...
import type { ActivityParticipant, ActivityResponse, ActivityTypeOption } from "../../types/activity";
...
/* ── Modal de détail (lecture seule + actions admin) ──────────────────────── */
...
function AdminActivityDetailModal({
  activity,
  open,
  onClose,
  onEdit,
